$(document).ready(function() {
	//adds span element * after each input element
	...
	var today = new Date();
	var month = today.getMonth() + 1; // Adds 1 since months starts at 0
	...
	$("#member_form").submit(
		function(event) {
			...
			// prevent the submission of form until all of the fields are valid
			if (isValid == false) {
